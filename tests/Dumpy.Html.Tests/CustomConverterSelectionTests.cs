...
public class CustomConverterSelectionTests
{
    ...
    {
        var type = HtmlDumpSink.GetUserDefinedConverterType(typeof(Car), new DumpOptions
        {
    ...
    {
        var type = HtmlDumpSink.GetUserDefinedConverterType(typeof(ICar), new DumpOptions
        {
            Converters = { typeof(CarHtmlConverter) }
        });
    ...
    {
        var type = HtmlDumpSink.GetUserDefinedConverterType(typeof(FlyingCar), new DumpOptions
        {
            Converters = { typeof(CarHtmlConverter) }
        });
    ...
    {
        var type = HtmlDumpSink.GetUserDefinedConverterType(typeof(Vehicle), new DumpOptions
        {
            Converters = { typeof(CarHtmlConverter) }
        });
