...
public class XmlNodeHtmlConverter : IHtmlConverter<XmlNode>
{
    public void Convert(ref ValueStringBuilder writer, XmlNode? value, Type targetType, HtmlDumpOptions options)
    {
        if (value is null)
        {
